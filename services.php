...
<body class="body-wrapper">
                ...
                <div class="col-md-6">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                          ...
                          <li class="breadcrumb-item active" aria-current="page">Services - Two</li>
                        </ol>
                    </nav>
                </div>
    ...
    <!-- digital-area end -->
    <section class="digital-area pb-xs-80 pt-xs-80 pt-sm-100 pb-sm-100 pt-md-100 pb-md-100 pt-120 pb-120 overflow-hidden">
        <div class="container">
            <div class="row mb-minus-30">
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="why-choose__item">
                        ...
                        <h5 class="title color-d_black mb-15 mb-xs-10">Digital Consulting</h5>
                        
                        <div class="description font-la">
                            <p>Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit sed quia consequuntu.</p>
                        </div>
                        
                        <a href="services-details.html">Read More <i class="far fa-chevron-double-right"></i></a>
                    </div>
                </div>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="why-choose__item">
                        ...
                        <h5 class="title color-d_black mb-15 mb-xs-10">Strategy & Research</h5>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    ...
                    <h5 class="title color-d_black mb-15 mb-xs-10">Tax Consulting</h5>
                ...
                <div class="col-xl-3 col-lg-4 col-sm-6">
                    <div class="why-choose__item">
                        ...
                        <h5 class="title color-d_black mb-15 mb-xs-10">Project Management</h5>
                    ...
                    <div class="get-free__content-wrapper overflow-hidden" style="background-image: url(assets/img/services/get-free-bg.png);">
                        <div class="get-free__content d-flex align-items-center justify-content-between">
                            ...
                            <div class="get-free__content-form">
                                <form class="d-flex flex-column flex-lg-row" action="mail.php" method="POST"> 
    ...
    <!-- similar-work start -->
    <section class="similar-work similar-work-services  bg-dark_white pb-xs-80 pb-sm-100 pb-md-100 pb-120 overflow">
        <div class="container">
            <div class="row mb-minus-30">
                <div class="col-lg-4 col-md-6">
                    <div class="similar-work__item reade-more-hidden mb-30 d-flex justify-content-between flex-column">
                        <div class="top d-flex align-items-center">
                            ...
                            <h4 class="title color-d_black"><a href="services-details.html">Finance & Strategy Service</a></h4>
                        </div>
                        ...
                        <div class="bottom">    
                            ...
                            <a href="services-details.html" class="theme-btn text-center fw-600">Read Details <i class="fas fa-long-arrow-alt-right"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="similar-work__item reade-more-hidden mb-30 d-flex justify-content-between flex-column">
                        <div class="top d-flex align-items-center">
                            ...
                            <h4 class="title color-d_black"><a href="services-details.html">Business Planning, Strategy & Execution</a></h4>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="similar-work__item reade-more-hidden mb-30 d-flex justify-content-between flex-column">
                        <div class="top d-flex align-items-center">
                            ...
                            <h4 class="title color-d_black"><a href="services-details.html">Financial Projections And Analysis</a></h4>
                        </div>
    ...
    <div class="why-counter__overly overflow-hidden">
        <div class="container">
                    ...
                    <div class="why-choose__content mt-lg-60 mt-md-50 mt-sm-40 mt-xs-35">
                        ...
                        <div class="why-choose__item-wrapper d-grid justify-content-between"> 
                            ...
                            <div class="why-choose__item">
                                ...
                                <h5 class="title color-d_black fw-500 mb-10">Lawyer Consulting</h5>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="h-faq-2">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#faq-2" aria-expanded="false" aria-controls="faq-2">
                                        <span>02.</span> We can help your business to grow?
                                    </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="h-faq-3">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#faq-3" aria-expanded="false" aria-controls="faq-3">
                                        <span>03.</span> Best financial and consultancy advisors?
                                    </button>
                                </h2>
    ...
    <!-- counter-area start -->
    <div class="counter-area pb-sm-100 pb-xs-80 pb-md-100 pb-120 overflow-hidden">
        <div class="container">
            <div class="row mb-minus-30">
                <div class="col-xl-3 col-lg-4 col-sm-6">
    ...
    <!-- can-help start -->
    <section class="can-help services-two bg-dark_white pb-xs-80 pt-xs-80 pt-sm-100 pb-sm-100 pt-md-100 pb-md-100 pt-120 pb-115 overflow-hidden">
        <div class="container">
            <div class="row">
                <div class="col-xl-7">
                    <div class="can-help__content  mb-sm-40 mb-xs-40 mb-md-45 mb-lg-50">
                        ...
                        <div class="help-text mb-md-25 mb-sm-25 mb-xs-20 mb-lg-25 mb-40">
                            <a href="contact.html"><img src="assets/img/icon/question-comment.svg" class="img-fluid mr-xs-10 mr-20" alt="">Need help? <span>Contact Us</span></a>
                        </div>
                ...
                <div class="col-xl-5">
                    <div class="contact-form pt-md-30 pt-sm-25 pt-xs-20 pb-md-40 pb-sm-35 pb-xs-30 pt-xl-30 pb-xl-50 pt-45 pr-xl-50 pl-md-40 pl-sm-30 pl-xs-25 pr-md-40 pr-sm-30 pr-xs-25 pl-xl-50 pr-85 pb-60 pl-85">
                        <div class="contact-form__header mb-sm-35 mb-xs-30 mb-40">
                            <h6 class="sub-title fw-500 color-primary text-uppercase mb-15"><img src="assets/img/team-details/badge-line.svg" class="img-fluid mr-10" alt=""> Get In Touch</h6>
                        ...
                        <form>
                            ...
                            <button type="submit" class="theme-btn btn-sm">Free Consultant <i class="far fa-chevron-double-right"></i></button>                            
                        </form>
                    </div>
                </div>
            </div>
    ...
    <div class="services-map">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="services-map__map" id="services-map__map"></div>
                </div>
            </div>
        </div>
    </div>
    ...
    <!-- client-brand start -->
    <div class="client-brand  pb-xs-80 pb-sm-100 pb-md-100 pb-105 overflow-hidden">
        <div class="container">
            <div class="row">
                <div class="col-12">
