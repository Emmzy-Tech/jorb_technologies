...
?>
            ...
            <div class="row align-items-center">
                <div class="col-xl-6">
                    <div class="banner-home__content pb-lg-60 pb-md-50 pb-sm-45 pb-xs-40">
                        <h6 class="sub-title color-white mb-20 mb-sm-15 mb-xs-10 d-inline-block">Welcome To <span>Jorb</span> Technologies</h6> 
                        ...
                        <div class="description font-la color-white mb-45 mb-md-30 mb-sm-25 mb-xs-20">
                            <p>We use today's innovative technologies to enable business solutions</p>
                        </div>
                ...
                <div class="col-xl-6">
                    <div class="banner-home__media">
                        ...
                        <img src="assets/img/banner/banner-img.jpg" class="img-fluid" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row mb-minus-30">
                <div class="col-xl-4 col-md-6">
                    <div class="financial__item d-flex mb-30" style="background-image: url(assets/img/home/financial__item-bg.png)">
                        <div class="icon">
                        ...
                        <div class="text">
                            <h6 class="title color-pd_black mb-10 mb-xs-5">Digital Transformation</h6>

                            <div class="description font-la">
                                <p>We accomplish this through Strategic consulting.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="financial__item d-flex mb-30" style="background-image: url(assets/img/home/financial__item-bg.png)">
                        ...
                        <div class="text">
                            <h6 class="title color-pd_black mb-10 mb-xs-5">Agile Software Solutions</h6>

                            <div class="description font-la">
                                <p>ncremental delivery, team collaboration, continual planning and perpetual learning.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="financial__item d-flex mb-30" style="background-image: url(assets/img/home/financial__item-bg.png)">
                        ...
                        <div class="text">
                            <h6 class="title color-pd_black mb-10 mb-xs-5">Complete IT Support</h6>

                            <div class="description font-la">
                                <p>All-inclusive IT support solution that secures and supports your network and team onsite, remotely, and in the cloud.</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <?php 
include("./assets/includes/about.php");
?>
    </div>
                ...
                <div class="col-sm-9">
                    <div class="planning-success__content mb-xs-35">
                        ...
                        <div class="description font-la color-white mb-40 mb-sm-30 mb-xs-20">
                            <p>
At Jorb Technologies, we match our clients’ needs with the latest technology and the ingenuity, skills, and experience of our professional team to provide the best services. Together, we reimagine and create incredible things while also rebranding existing ones. So let’s help you or your business!</p>
                        </div>
