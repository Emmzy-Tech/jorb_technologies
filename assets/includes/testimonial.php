<div class="testimonial-bg" style="background-image: url(assets/img/about/testimonial-bg.png);">
        <!-- testimonial start -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="testimonial__content mb-60 mb-md-50 mb-sm-40 mb-xs-30 text-center">
                            ...
                            <h2 class="title color-d_black"><span>Customer Feedback</span></h2>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!-- client-brand start -->
        <div class="client-brand  pb-xs-80 pb-md-100 pb-sm-100 pb-lg-100 pb-105 overflow-hidden">
            <div class="container">
                <div class="row">
                    <div class="col-12">
