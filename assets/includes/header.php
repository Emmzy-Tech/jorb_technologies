...
<head>
    ...
    <meta name="author" content="capacitybay">
    <!-- ======== Page title ============ -->
    <title>Jorb Technologies | Welcome</title>
    <!-- ========== Favicon Icon ========== -->
                    ...
                    <div class="col-8">
                        <div class="header-cta d-flex justify-content-end">
                            <ul>
                                ...
                                <li><a href="mailto:info@jorbtechnologies.com"><i class="icon-email"></i>info@jorbtechnologies.com</a></li>
