                        ...
                        <div class="can-help__content-btn-group d-flex flex-column flex-sm-row">
                            <a href="tel:+1235568824" class="theme-btn d-flex flex-column flex-md-row align-items-md-center">
                                ...
                                <div class="text">
                                    ...
                                    <h5 class="fw-500 color-white">+(212)-226-3126</h5>
                                </div>
                            </a>

                            <a href="mailto:info@jorbtechnonogies.com" class="theme-btn d-flex flex-column flex-md-row align-items-md-center">
                                <div class="icon color-red">
                                ...
                                <div class="text">
                                    ...
                                    <h5 class="fw-500 color-white">info@jorbtechnologies.com</h5>
                                </div>
                            </a>
                        </div>
                    </div>
                ...
                <div class="col-xl-5">
                    <div class="contact-form pt-md-30 pt-sm-25 pt-xs-20 pb-md-40 pb-sm-35 pb-xs-30 pt-xl-30 pb-xl-50 pt-45 pr-xl-50 pl-md-40 pl-sm-30 pl-xs-25 pr-md-40 pr-sm-30 pr-xs-25 pl-xl-50 pr-85 pb-60 pl-85">
                        <div class="contact-form__header mb-sm-35 mb-xs-30 mb-40">
                            ...
                            <h3 class="title color-d_black">Book an Appointment</h3>
                        </div>
                        ...
                        <form action="mail.php" method="POST">
                            ...
                            <button type="submit" class="theme-btn btn-sm btn-red">Book Now <i class="far fa-chevron-double-right"></i></button>                            
                        </form>
                    </div>
                </div>
            </div>
