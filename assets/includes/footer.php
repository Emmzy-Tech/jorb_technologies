            ...
            <div class="row justify-content-between">
                <div class="col-md-6 col-xl-3">
                    <div class="single-footer-wid widget-description">
                        ...
                        <a href="#" class="theme-btn btn-red btn-md fw-600">About Us<i class="far fa-chevron-double-right"></i></a>
                    </div>
            ...
            <div class="container">
                <div class="footer-bottom-content d-flex flex-column flex-md-row justify-content-between align-items-center">
                    <div class="coppyright text-center text-md-start">
                        &copy; 2023 <a href="index.html">Jorb Technologies</a> | All Rights Reserved by <a href="https://capacitybay.org">CapacityBay</a>
                    </div>
